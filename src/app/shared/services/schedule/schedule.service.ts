...
export class ScheduleService {
   ...
   */
  public createSchedule(create: Partial<Franchisee>, schedule: Partial<Schedule>): Observable<Schedule> {
   ...
   * @returns update schedule
   */
  public updateSchedule(update: Partial<Franchisee>, schedule: Partial<Schedule>): Observable<any> {

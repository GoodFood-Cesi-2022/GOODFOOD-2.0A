...
describe("ScheduleService", () => {
  ...
  describe("get schedule", () => {
    ...
    it("should return schedule", () => {
      service.getSchedule(mockFranchisee).subscribe({
        next: (values) => expect(values).withContext("should return schedule").toEqual(mockSchedule),
        error: fail,
      });

      const req = httpTestingController.expectOne(`${environment.apiBaseUrl}/contractors/${mockFranchisee.id}/times`);
  ...
  describe("should call createSchedule()", (): void => {
    ...
    it("should return new schedule", (): void => {
      service.createSchedule(mockFranchisee, mockSchedule).subscribe((data): void => {
  ...
  describe("should call updateSchedule()", (): void => {
    ...
    it("should update schedule and return success message", (): void => {
      service.updateSchedule(mockFranchisee, mockSchedule).subscribe({
        next: (data): void => expect(data).withContext("should return the message").toEqual(data),
        error: fail,
      });
